...
- [Aritmetica_Modular.py](https://github.com/Starknet-Es/Maths-StarknetEs/blob/main/Gu%C3%ADas%20Completas/Aritm%C3%A9tica%20Modular/Contracts/Python/Aritmetica_Modular.py)- Código para resolver el [ejercio de una expresión matemática](https://github.com/Starknet-Es/Maths-StarknetEs/tree/main/Gu%C3%ADas%20Completas/Aritm%C3%A9tica%20Modular#hagamos-este-ejercicio)
...
```python
python3.9 Aritmetica_Modular.py
```

![Graph](https://github.com/Starknet-Es/Maths-StarknetEs/blob/main/Gu%C3%ADas%20Completas/Im%C3%A1genes/modpy.png)
![Graph](https://github.com/Starknet-Es/Maths-StarknetEs/blob/main/Gu%C3%ADas%20Completas/Im%C3%A1genes/modpy2.png)
